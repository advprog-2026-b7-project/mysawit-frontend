...
export default function MandorWalletPage() {
  const { user, loading: authLoading } = useRoleDashboard("MANDOR");
  ...
  return (
    <AdminLayout activePage="Payment & Wallet" currentUser={user}>
      <div style={{ padding: "32px 0" }}>
        ...
        >
          Your total earnings from approved payrolls
        </p>
